...
public enum ErrorCode {
    ...
    INVALID_LOCATION(HttpStatus.BAD_REQUEST, 1005, "유효하지 않는 위치입니다."),

    // Auth & User - 2000
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, 2000, "등록되지 않은 사용자입니다."),

    // Crop - 3000
    CROP_NOT_FOUND(HttpStatus.NOT_FOUND, 3000, "등록되지 않은 농작물입니다."),
    CROP_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, 3001, "등록되지 않은 농작물 카테고리입니다.")
