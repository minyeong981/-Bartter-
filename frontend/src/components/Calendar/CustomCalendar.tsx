...
export default function CustomCalendar({
  ...
  const renderWeekday = (date: Date): string => {
      ...
      <div className="react-calendar collapsed-calendar">
        ...
        <div className="react-calendar__month-view__weekdays">
          {currentWeek.map((date, index) => (
            ...
            >
              <abbr title={renderWeekday(date)}>{renderWeekday(date)}</abbr>
            </div>
          ))}
        </div>
        <div className="react-calendar__month-view__days">
          {currentWeek.map(date => (
            ...
            >
              <abbr className="react-calendar__tile__abbr">
                {date.getDate()}
              </abbr>
            </div>
          ))}
  ...
  return (
    <div
      className={`custom-calendar-container ${isCollapsed ? 'collapsed' : ''}`}
    >
