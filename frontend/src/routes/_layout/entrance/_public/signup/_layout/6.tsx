...
import type {SearchParamFromPhase4} from '@/routes/_layout/entrance/_public/signup/_layout/5.tsx';
...
export const Route = createFileRoute(
  ...
  beforeLoad: async ({search}) => {
    if (!search.gender)
      throw redirect({to: '/entrance/signup/5', search: {...search}});
  },
});
